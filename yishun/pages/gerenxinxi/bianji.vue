...
<script>
	...
	export default {
		...
		methods: {
			...
			confirm() {
				this.userDetailTransfer.account = inf.account;
			    ...
			    this.userDetailTransfer.province = b[0];
				this.userDetailTransfer.city = b[1];
				this.userDetailTransfer.area = b[2];
